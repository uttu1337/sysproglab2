...
void handle_request(const char *request, char *response) {
    ...
    if (strcmp(command, "add_product") == 0 && args_count >= 3) {
        ...
        add_product("/Users/georgijzukov/Documents/system_prog2/system_prog2/goods.txt", product);
        ...
        FILE *file = fopen("/Users/georgijzukov/Documents/system_prog2/system_prog2/goods_movement.txt", "rb");
        if (!file) {
        ...
        add_delivery("/Users/georgijzukov/Documents/system_prog2/system_prog2/goods_delivery.txt", delivery);
